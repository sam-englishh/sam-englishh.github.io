...
## Visualization
I used piping to get the necessary information.
...
## Project 1 - Part 2 - Chocolate Ratngs by Percent Cocoa
...
In this project, I focused on data involving Netflix titles and made three visualizations. The prupose of this project was to use piping to organize data, and focus on the use of regular expressions to assist in this process, so it is easier to understand and present.
...
```
Here is the visualization that came from this dataset.
...
This project involved running permutation tests assuming a null hypothesis to test whether a relationship exists between two variables. In my analysis, I was testing the relationship between parental and child use of marijuana. This was my favourite project. I really enjoyed running the statistical analysis and demonstrating the data.
...
```{sql, connection=con_wai, output.var="data", echo= FALSE, eval= TRUE}
SELECT 
  Measurements.Identifier,
  COUNT(DISTINCT CONCAT(Measurements.SubjectNumber, Measurements.Ear)) AS Unique_Ears,
  PI_Info.AuthorsShortList,
...
In my second visualization I compare the mean absorbances across the study conducted by Abur in 2004. I differentiate between Men, Women and the studies where the sex of the subject was unknown. Here is the visualization.
